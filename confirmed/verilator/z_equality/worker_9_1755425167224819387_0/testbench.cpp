...
int main(int argc, char** argv) {
    ...
    bool clk;
    bool in;
    uint8_t inj_i_target_data_1755425167519_276;
    bool rst;
    ...
    std::ifstream inj_i_target_data_1755425167519_276_file("input_inj_i_target_data_1755425167519_276.hex");
    if (!inj_i_target_data_1755425167519_276_file.is_open()) {
        std::cerr << "Failed to open input file for inj_i_target_data_1755425167519_276: input_inj_i_target_data_1755425167519_276.hex" << std::endl;
        return 1;
    }
    std::string inj_i_target_data_1755425167519_276_hex_str;
    inj_i_target_data_1755425167519_276_file >> inj_i_target_data_1755425167519_276_hex_str;
    if (inj_i_target_data_1755425167519_276_file.fail() && !inj_i_target_data_1755425167519_276_file.eof()) {
        std::cerr << "Failed to read hex string for inj_i_target_data_1755425167519_276 from input file: input_inj_i_target_data_1755425167519_276.hex" << std::endl;
        inj_i_target_data_1755425167519_276_file.close();
        return 1;
    }
    std::stringstream ss_inj_i_target_data_1755425167519_276;
    ss_inj_i_target_data_1755425167519_276 << std::hex << inj_i_target_data_1755425167519_276_hex_str;
    unsigned int temp_inj_i_target_data_1755425167519_276;
    if (!(ss_inj_i_target_data_1755425167519_276 >> temp_inj_i_target_data_1755425167519_276)) {
        std::cerr << "Failed to parse hex value for inj_i_target_data_1755425167519_276: " << inj_i_target_data_1755425167519_276_hex_str << std::endl;
        inj_i_target_data_1755425167519_276_file.close();
        return 1;
    }
    inj_i_target_data_1755425167519_276 = static_cast<uint8_t>(temp_inj_i_target_data_1755425167519_276);
    inj_i_target_data_1755425167519_276_file.close();
    ...
    _set_port_value<uint8_t>(m_caseeq_demo_i.p_inj__i__target__data__1755425167519__276, inj_i_target_data_1755425167519_276);
    ...
    std::ofstream inj_o_target_result_1755425167519_359_file("output_inj_o_target_result_1755425167519_359.hex");
    if (!inj_o_target_result_1755425167519_359_file.is_open()) {
        std::cerr << "Failed to open output file for inj_o_target_result_1755425167519_359: output_inj_o_target_result_1755425167519_359.hex" << std::endl;
        return 1;
    }
    for (int i = 7; i >= 0; --i) {
        inj_o_target_result_1755425167519_359_file << (_get_port_value(m_caseeq_demo_i.p_inj__o__target__result__1755425167519__359, i) ? '1' : '0');
    }
    inj_o_target_result_1755425167519_359_file << std::endl;
    inj_o_target_result_1755425167519_359_file.close();
